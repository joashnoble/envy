...
class RefYearSetup extends CORE_Controller
{
    ...
    public function index() {
        ...
        $data['month'] = $this->Month_model->get_list();
    ...
    function transaction($txn = null) {
        switch ($txn) {
            ...
            case 'create':
                ...
                $m_yearsetup->start_month = $this->input->post('start_month', TRUE);
                $m_yearsetup->end_month = $this->input->post('end_month', TRUE);
                $m_yearsetup->factor_setup = $this->get_numeric_value($this->input->post('factor_setup', TRUE));
                $m_yearsetup->save();
