    ...
    function transaction($txn = null) {
        switch ($txn) {
            ...
            case 'create':
                ...
                $m_employee->month_contract_1 = $this->input->post('month_contract_1', TRUE);
                $m_employee->month_contract_5 = $this->input->post('month_contract_5', TRUE);
                $m_employee->reg_contract = $this->input->post('reg_contract', TRUE);
                $m_employee->perfomance_eval_1 = $this->input->post('perfomance_eval_1', TRUE);
                $m_employee->perfomance_eval_2 = $this->input->post('perfomance_eval_2', TRUE);
