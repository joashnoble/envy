        ...
        switch ($txn) {
            ...
            case 'upload':
                ...
                $excel->getActiveSheet()->setCellValue('A4', 'Fullname')
                                        ...
                                        ->setCellValue('O4', 'TIN')
                                        ->setCellValue('P4', 'Bank Account #')
                                        ->setCellValue('Q4', 'Employee Type')
                                        ->setCellValue('R4', 'Department')
                                        ->setCellValue('S4', 'Position')
                                        ->setCellValue('T4', 'Branch')
                                        ->setCellValue('U4', 'Section')
                                        ->setCellValue('V4', 'Pay Type')
                                        ->setCellValue('W4', 'Group')
                                        ->setCellValue('X4', 'Employment Date')
                                        ->setCellValue('Y4', 'Address1')
                                        ->setCellValue('Z4', 'Address2')
                                        ->setCellValue('AA4', 'Email Address')
                                        ->setCellValue('AB4', 'Mobile No')
                                        ->setCellValue('AC4', 'Phone No')
                                        ->setCellValue('AD4', 'Retired?');
                ...
                $excel->getActiveSheet()->getStyle('A4:AD4')->getFill()
                ...
                $excel->getActiveSheet()->getStyle('A4:AD4')->applyFromArray($styleArray);
