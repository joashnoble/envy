...
<!--                                     <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      <label class="col-sm-4 inlinecustomlabel" for="inputPassword1">Starting Date :</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                      <label class="col-sm-4 inlinecustomlabel" for="inputPassword1">Ending Date :</label>
                                        <div class="col-sm-8">
    ...
    var initializeControls=function(){
        dt=$('#tbl_deduction_regular_list').DataTable({
            ...
            "columns": [
                ...
                { targets:[8],data: "deduction_regular_remarks" },
                {
                    targets:[9],
                    render: function (data, type, full, meta){
                ...
                { targets:[10],data: "deduction_regular_id",visible:false }
            ],
            language: {
