            ...
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="BirthdayCelebrant">Birthday Celebrant</a></li>
                    </ol>
                                ...
                                <div class="panel-body table-responsive">
                                    <div style="margin: 15px;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <button type="button" class="col-sm-12 btn form-control" id="print_bday_list" style="background-color:#27ae60; color:white;width: 100px;margin-top: 30px;"><i class="fa fa-print"></i> PRINT</button>

                                                <button type="button" class="col-sm-12 btn btn-primary form-control" id="export_bday_list" style="color:white;margin-left: 20px;margin-top: 30px;width: auto;"><i class="fa fa-file-excel-o"></i> EXPORT EXCEL</button>

                                                <button type="button" class="col-sm-12 btn btn-info form-control" id="email_bday_list" style="color:white;margin-left: 20px;margin-top: 30px; width: 100px;"><i class="fa fa-envelope"></i> EMAIL</button>
                                            </div>
...
$(document).ready(function(){
    ...
    $.ajax({
        "dataType":"html",
        "type":"POST",
        "url":"Hris_Reports/reports/bday-list/"+filter_month+"",
        beforeSend : function(){
    ...
    $('#print_bday_list').click(function(event){
            showinitializeprint();
    ...
    $('#export_bday_list').on('click', function() {
        filter_month = $('#month_filter').val();
        window.open("Hris_Reports/reports/export-bday-list/"+filter_month+"","_self");
    });

    $('#email_bday_list').on('click', function() {
        filter_month = $('#month_filter').val();
    ...
    $.ajax({
        "dataType":"json",
        "type":"POST",
        "url":"Hris_Reports/reports/email-bday-list/"+filter_month+"",
