            ...
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="PagIbigReports">Pag-Ibig Reports</a></li>
                    </ol>
                        ...
                        <div id="div_2316_list">
                            <div class="panel panel-default">
                                <div class="panel-heading" style="background-color:#2c3e50 !important;margin-top:2px;">
                                     <center><h2 style="color:white;font-weight:300;">Pag-Ibig Report </h2></center>
                                </div>
                                <div class="panel-body table-responsive" style="padding-top:10px; margin-top: 10px;">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="row" style="margin-top: 10px;">
                                        <div class="col-md-3">
                                            <button type="button" class="btn col-sm-12 form-control" id="print_pagibig_list" style="background-color:#27ae60; color:white;margin-left: 20px; width: 200px;">PRINT</button>
                                        </div>
                                    </div>
                                    <hr>
...
$(document).ready(function(){
    ...
    $.ajax({
        "dataType":"html",
        "type":"POST",
        "url":"Hris_Reports/reports/pagibig-list/"+filter_branch+"/"+filter_month+"/"+filter_pay_period+"",
        beforeSend : function(){
