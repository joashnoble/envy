                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body table-responsive" style="padding-top:8px;">
                                    ...
                                    <div class="row" style="margin-top: 5px;">
                                        <div class="col-md-3">
                                            <button type="button" class="btn col-sm-12 form-control" id="print_emp_sched_report" style="background-color:#27ae60;color:white;margin-left: 20px">PRINT</button>
                                        </div>
                                    </div>
                                    <hr>
                                    <div id="emp_sched_preview" style="overflow: scroll;">
                                    </div>
                                </div>
...
$(document).ready(function(){
    ...
    $.ajax({
        "dataType":"html",
        "type":"POST",
        "url":"PayrollReports/payrollreports/emp_sched_report/"+filter_employee+"/"+filter_payperiod+"",
        beforeSend : function(){
