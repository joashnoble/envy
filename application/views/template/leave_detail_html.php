	...
	<div class="col-md-12">
		<div class="row">
			<div class="div-tables">
				...
				<tr>
					<td colspan="2" id="name"><span id="title">Employee:</span> <?php echo $row->fullname;?></td>
					<td colspan="2" id="name" align="right"><span id="title">Total Leave Request:</span> <?php echo $row->total;?></td>
