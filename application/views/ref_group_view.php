                    ...
                    <div class="container-fluid">
                        ...
                        <div id="div_product_list">
                            <div class="panel panel-default">
                                        <button class="btn right_group_create"  id="btn_new" style="width:130px;background-color:#2ecc71;color:white;" title="Create New Group" >
            ...
            "columns": [
                ...
                { targets:[1],data: "group_desc" },
                {
                    ...
                    render: function (data, type, full, meta){
                        ...
                        return '<center>'+right_group_edit+right_group_delete+'</center>';
                    }
                }
