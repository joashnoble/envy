            ...
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="EmployeeTenure">Employee Tenure</a></li>
                    </ol>
...
$(document).ready(function(){
    ...
    $.ajax({
        "dataType":"html",
        "type":"POST",
        "url":"Hris_Reports/reports/employee-tenure/0/"+filter_branch+"/0",
        beforeSend : function(){
    ...
    $('#print_employee_tenure').click(function(event){
            showinitializeprint();
 ...
 $('#export_employee_tenure').on('click', function() {
        filter_branch = $('#branch_filter_list').val();
        window.open("Hris_Reports/reports/export-employee-tenure/0/"+filter_branch+"/0","_self");
    });

    $('#email_employee_tenure').on('click', function() {
        filter_branch = $('#branch_filter_list').val();
    ...
    $.ajax({
        "dataType":"json",
        "type":"POST",
        "url":"Hris_Reports/reports/email-employee-tenure/0/"+filter_branch+"/0",
