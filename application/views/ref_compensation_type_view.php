                    ...
                    <div class="container-fluid">
                        ...
                        <div id="div_product_list">
                            <div class="panel panel-default">
                                        <button class="btn right_compensation_view"  id="btn_new" style="width:235px;background-color:#2ecc71;color:white;" title="Create New Compensation Type" >
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        dt=$('#tbl_compensation_type').DataTable({
            ...
            "columns": [
                { targets:[0],data: "compensation_type" },
                { targets:[1],data: "description" },
                {
                    targets:[2],
                    render: function (data, type, full, meta){

                        return '<center>'+right_compensation_edit+right_compensation_delete+'</center>';
                    }
                }
