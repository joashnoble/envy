...
<div id="wrapper">
    <div id="layout-static">
        ...
        <div class="static-content-wrapper white-bg">
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="RefCertificate">Certificate</a></li>
                    </ol>
                        ...
                        <div id="div_product_list">
                            <div class="panel panel-default">
                                    ...
                                    <div class="panel-body table-responsive" style="padding-top:8px;">
                                        <table id="tbl_certificate" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
            ...
            <div id="modal_create_certificate" class="modal fade" tabindex="-1" role="dialog"><!--modal-->
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color:#2ecc71;">
                            <button type="button" class="close"   data-dismiss="modal" aria-hidden="true">X</button>
                            <h4 class="modal-title" style="color:#ecf0f1;"><span id="modal_mode"> </span>Certificate : <transaction class="transaction_type"></transaction></h4>
                        </div>

                        <div class="modal-body">
                            <form id="frm_certificate">
                            <div class="row">
                              <div class="col-md-12">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group" style="margin-bottom:0px;">
                                    ...
                                    <textarea type="text" class="form-control" id="description" name="description" placeholder="Certificate Description"></textarea>
                                </div>
                              </div>
                            </div>
                            </form>
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        dt=$('#tbl_certificate').DataTable({
            "aLengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
            "ajax" : "RefCertificate/transaction/list",
            "columns": [
                { targets:[0],data: "certificate" },
                { targets:[1],data: "description" },
                {
                    targets:[2],
                    render: function (data, type, full, meta){

                        return '<center>'+right_certificate_edit+right_certificate_delete+'</center>';
                    }
                }
    ...
    var bindEventHandlers=(function(){
        ...
        $('#tbl_certificate tbody').on( 'click', 'tr td.details-control', function () {
        ...
        $('#tbl_certificate tbody').on('click','button[name="edit_info"]',function(){
            _txnMode="edit";
            $('.transaction_type').text('Edit');
            $('#modal_create_certificate').modal('show');
            _selectRowObj=$(this).closest('tr');
            var data=dt.row(_selectRowObj).data();
            _selectedID=data.ref_certificate_id;
        ...
        $('#tbl_certificate tbody').on('click','button[name="remove_info"]',function(){
            _selectRowObj=$(this).closest('tr');
            var data=dt.row(_selectRowObj).data();
            _selectedID=data.ref_certificate_id;
        ...
        $('#btn_yes').click(function(){
            removeCertificate().done(function(response){
        ...
        $('#btn_new').click(function(){
            ...
            $('#modal_create_certificate').modal('show');
            clearFields($('#frm_certificate'));
        });

        $('#btn_create').click(function(){
            if(validateRequiredFields($('#frm_certificate'))){
                if(_txnMode==="new"){
                    //alert("aw");
                    createCertificate().done(function(response){
                        ...
                        $.unblockUI();
                        $('#modal_create_certificate').modal('toggle');
                    });
                    return;
                }
                if(_txnMode==="edit"){
                    //alert("update");
                    updateCertificate().done(function(response){
                        showNotification(response);
                        if(response.stat=="error"){
                            $.unblockUI();
                             }
    ...
    var createCertificate=function(){
        var _data=$('#frm_certificate').serializeArray();

        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"RefCertificate/transaction/create",
            "data":_data,
    ...
    var updateCertificate=function(){
        ...
        console.log(_data);
        _data.push({name : "ref_certificate_id" ,value : _selectedID});
        ...
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"RefCertificate/transaction/update",
            "data":_data,
            "beforeSend": showSpinningProgress($('#btn_save'))
        });
    };

    var removeCertificate=function(){
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"RefCertificate/transaction/delete",
            "data":{ref_certificate_id : _selectedID},
            "beforeSend": showSpinningProgress($('#btn_save'))
        });
    };
