            ...
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="EmployeeDeductionHistory">Employee Deduction History</a></li>
                    </ol>
                        ...
                        <div id="div_2316_list">
                            <div class="panel panel-default">
                                <div class="panel-heading" style="background-color:#2c3e50 !important;margin-top:2px;">
                                     <center><h2 style="color:white;font-weight:300;">Employee Deduction History</h2></center>
                                </div>
...
$(document).ready(function(){
    ...
    _datefilter=$("#payperiod_demog_filter").select2({
        /*dropdownParent: $("#modal_create_schedule"),*/
    ...
    $('#payperiod_demog_filter').val(d.getFullYear()).trigger("change")
    ...
    $.ajax({
        "dataType":"html",
        "type":"POST",
        "url":"PayrollHistory/layout/employee-deduction-history/"+filterdemogemp+"/"+filterdemog+"/0",
        beforeSend : function(){
