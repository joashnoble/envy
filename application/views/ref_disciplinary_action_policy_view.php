...
<div id="wrapper">
    <div id="layout-static">
        ...
        <div class="static-content-wrapper white-bg">
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="RefDiscipline">Disciplinary Action Policy</a></li>
                    </ol>
                    ...
                    <div class="container-fluid">
                        ...
                        <div id="div_product_list">
                            <div class="panel panel-default">
                                        <button class="btn right_disciplinary_view"  id="btn_new" style="width:300px;background-color:#2ecc71;color:white;" title="Create New Disciplinary Action Policy" >
                                        <i class="fa fa-file"></i> New Disciplinary Action Policy</button>
                                    ...
                                    <div class="panel-body table-responsive" style="padding-top:8px;">
                                        <table id="tbl_disciplinary" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Disciplinary Action Policy Name</th>
                                                    <th>Description</th>
            ...
            <div id="modal_create_discipline" class="modal fade" tabindex="-1" role="dialog"><!--modal-->
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group" style="margin-bottom:0px;">
                                    ...
                                    <textarea type="text" class="form-control" id="description" name="description" placeholder="Disciplinary Action Policy Description"></textarea>
                                </div>
                              </div>
                            </div>
                            </form>
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        dt=$('#tbl_disciplinary').DataTable({
            ...
            "ajax" : "RefDiscipline/transaction/list",
            "columns": [
                { targets:[0],data: "disciplinary_action_policy" },
                { targets:[1],data: "description" },
                {
                    targets:[2],
                    render: function (data, type, full, meta){

                        return '<center>'+right_disciplinary_edit+right_disciplinary_delete+'</center>';
                    }
                }

            ],
            language: {
                         searchPlaceholder: "Search Disciplinary Action Policy"
                     },
    ...
    var bindEventHandlers=(function(){
        ...
        $('#btn_yes').click(function(){
            removeDiscipline().done(function(response){
        ...
        $('#btn_create').click(function(){
            if(validateRequiredFields($('#frm_discipline'))){
                if(_txnMode==="new"){
                    //alert("aw");
                    createDiscipline().done(function(response){
                        showNotification(response);
                        dt.row.add(response.row_added[0]).draw();
                        clearFields($('#frm_discipline'))
                    }).always(function(){
                        $.unblockUI();
                        $('#modal_create_discipline').modal('toggle');
                    });
                    return;
                }
                if(_txnMode==="edit"){
    ...
    var createDiscipline=function(){
        var _data=$('#frm_discipline').serializeArray();

        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"RefDiscipline/transaction/create",
            "data":_data,
    ...
    var updateDiscipline=function(){
        var _data=$('#frm_discipline').serializeArray();

        console.log(_data);
        _data.push({name : "ref_disciplinary_action_policy_id" ,value : _selectedID});
        ...
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"RefDiscipline/transaction/update",
            "data":_data,
            "beforeSend": showSpinningProgress($('#btn_save'))
        });
    };

    var removeDiscipline=function(){
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"RefDiscipline/transaction/delete",
            "data":{ref_disciplinary_action_policy_id : _selectedID},
            "beforeSend": showSpinningProgress($('#btn_save'))
        });
    };
