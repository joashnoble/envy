            ...
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="ManPowerList">Man Power List (Active)</a></li>
                    </ol>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body table-responsive" style="padding-top:8px;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" class="btn col-sm-12 form-control" id="print_manpower_list" style="background-color:#27ae60; color:white;width: 100px;margin-top: 30px;"><i class="fa fa-print"></i> PRINT</button>

                                            <button type="button" class="btn btn-primary col-sm-12 form-control" id="export_manpower_list" style="color:white;margin-left: 20px;margin-top: 30px;width: auto;"> <i class="fa fa-file-excel-o"></i> EXPORT EXCEL</button>

                                            <button type="button" class="btn btn-info col-sm-12 form-control" id="email_manpower_list" style="color:white;margin-left: 20px;margin-top: 30px; width: 100px;"><i class="fa fa-envelope"></i> EMAIL</button>
                                        </div>
...
$(document).ready(function(){
    ...
    $.ajax({
        "dataType":"html",
        "type":"POST",
        "url":"Hris_Reports/reports/manpower-list/0/"+filter_branch+"/0",
        beforeSend : function(){
    ...
    $('#print_manpower_list').click(function(event){
            showinitializeprint();
...
$('#export_manpower_list').on('click', function() {
        filter_department = $('#department_filter_list').val();
        filter_branch = $('#branch_filter_list').val();
        window.open("Hris_Reports/reports/export-manpower-list/0/"+filter_branch+"/0","_self");
    });

    $('#email_manpower_list').on('click', function() {
        filter_department = $('#department_filter_list').val();
        filter_branch = $('#branch_filter_list').val();
    ...
    $.ajax({
        "dataType":"json",
        "type":"POST",
        "url":"Hris_Reports/reports/email-manpower-list/0/"+filter_branch+"/0",
