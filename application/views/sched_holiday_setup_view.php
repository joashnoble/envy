            ...
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="SchedHolidaySetup">SchedHolidaySetup</a></li>
                    </ol>
                    ...
                    <div class="container-fluid">
                        ...
                        <div id="div_product_list">
                            <div class="panel panel-default">
                                        ...
                                        <i class="fa fa-file"></i> New SchedHolidaySetup</button>
                                        <div class="panel-heading" style="background-color:#2c3e50 !important;margin-top:2px;">
                                             <center><h2 style="color:white;font-weight:300;">SchedHolidaySetup List</h2></center>
                                        </div>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color:#2ecc71;">
                            <button type="button" class="close"   data-dismiss="modal" aria-hidden="true">X</button>
                            <h4 class="modal-title" style="color:#ecf0f1;"><span id="modal_mode"> </span>SchedHolidaySetup : <transaction class="transaction_type"></transaction></h4>
                        </div>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group" style="margin-bottom:0px;">
                                    <label class="boldlabel">*Day Type :</label>
                                    <select name="ref_day_type_id" class="form-control">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group" style="margin-bottom:0px;">
                                    ...
                                    <input type="text" class="form-control date-picker"  name="date" placeholder="SchedHolidaySetup Description">
                                </div>
                              </div>
                            </div>
                            </form>
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        dt=$('#tbl_schedholidaysetup').DataTable({
            ...
            language: {
                         searchPlaceholder: "Search SchedHolidaySetup"
                     },
