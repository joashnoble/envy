                    ...
                    <div class="container-fluid">
                        ...
                        <div id="div_product_list">
                            <div class="panel panel-default">
                                        <button class="btn right_religion_create"  id="btn_new" style="width:185px;background-color:#2ecc71;color:white;" title="Create New Religion" >
                                    ...
                                    <div class="panel-body table-responsive" style="padding-top:8px;">
                                        <table id="tbl_religion" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Religion Name</th>
                                                    <th>Description</th>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color:#2ecc71;">
                            <button type="button" class="close"   data-dismiss="modal" aria-hidden="true">X</button>
                            <h4 class="modal-title" style="color:#ecf0f1;"><span id="modal_mode"> </span>Religion : <transaction class="transaction_type"></transaction></h4>
                        </div>
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        dt=$('#tbl_religion').DataTable({
            "aLengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
            "ajax" : "RefReligion/transaction/list",
            "columns": [
                { targets:[0],data: "religion" },
                { targets:[1],data: "description" },
                {
                    targets:[2],
                    render: function (data, type, full, meta){

                        return '<center>'+right_religion_edit+right_religion_delete+'</center>';
                    }
                }
    ...
    var bindEventHandlers=(function(){
        ...
        $('#tbl_religion tbody').on( 'click', 'tr td.details-control', function () {
        ...
        $('#tbl_religion tbody').on('click','button[name="edit_info"]',function(){
            _txnMode="edit";
        ...
        $('#tbl_religion tbody').on('click','button[name="remove_info"]',function(){
            _selectRowObj=$(this).closest('tr');
            var data=dt.row(_selectRowObj).data();
            _selectedID=data.ref_religion_id;
