...
$(document).ready(function(){
    ...
    var bindEventHandlers=(function(){
        ...
        $('#select_dtr').click(function(){
            ...
            "dataType":"html",
            "type":"POST",
            "url":"PayrollReports/payrollreports/payroll-register-summary-list/"+_selectedYear+"/"+_deptId+"/"+_brachId+"/fullview",
            beforeSend : function(){
                        $('#payroll_register_preview').html("<center><img src='assets/img/loader/preloaderimg.gif'><h3>Loading...</h3></center>");
                    },
            }).done(function(response){
                $('#payroll_register_preview').html(response);
            });
            //$('#modal_filter').modal('toggle');
            $('#modal_payroll_register_list').modal('toggle');
    ...
    $("#download_payrollregistersummary").click(function(){
        var _deptId = $('#ref_department_id').val();
        var _brachId = $('#ref_branch_id').val();
                window.location = "PayrollReports/payrollreports/payroll-register-summary-list/"+_selectedYear+"/"+_deptId+"/"+_brachId+"/pdf";
            //alert(_selectedID);
        });

    $("#print_payrollregistersummary").click(function(){
        var _deptId = $('#ref_department_id').val();
        var _brachId = $('#ref_branch_id').val();
                window.open('PayrollReports/payrollreports/payroll-register-summary-list/'+_selectedYear+'/'+_deptId+'/'+_brachId+'/preview', '_blank');
            //alert(_selectedID);
        });
    ...
    <div id="layout-static">
        ...
        <div class="static-content-wrapper white-bg">
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="PayrollSummary">Payroll Register Summary</a></li>
                    </ol>
            ...
            <div id="modal_filter" class="modal fade" tabindex="-1" role="dialog"><!--modal-->
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color:#27ae60;">
                            ...
                            <h4 class="modal-title" style="color:white;"><span id="modal_mode"> Select Pay Period (Payroll Register Summary) </h4>
                        </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-8">
                                <div class="form-group" style="margin-bottom:0px;">
                                    ...
                                    <select id='pay_period' class='form-control' name='pay_period'>
                ...
                <div id="modal_payroll_register_list" class="modal fade"  role="dialog"><!--modal-->
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color:#27ae60;">
                            <button type="button" style="color:white;" class="close"  data-dismiss="modal" aria-hidden="true">X</button>
                            <h4 class="modal-title" style="color:white;"><span id="modal_mode"> Payroll Summary </h4>
                        </div>
                        <div class="modal-body">
                            <div class="container-fluid" id="payroll_register_preview" style="overflow:scroll;width:100%;">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button id="print_payrollregistersummary" type="button" class="btn btn-success">PRINT</button>
                            <button id="download_payrollregistersummary" type="button" class="btn btn-success">Download PDF</button>
                            <button id="btn_close_dtr" type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                        </div>
                    </div>
                </div>
