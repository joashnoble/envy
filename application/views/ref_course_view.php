            ...
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="RefCourse">Course</a></li>
                    </ol>
                    ...
                    <div class="container-fluid">
                        ...
                        <div id="div_product_list">
                            <div class="panel panel-default">
                                        <button class="btn right_course_create"  id="btn_new" style="width:185px;background-color:#2ecc71;color:white" title="Create New Course" >
                                        <i class="fa fa-file"></i> New Course</button>
                                        <div class="panel-heading" style="background-color:#2c3e50 !important;margin-top:2px;">
                                             <center><h2 style="color:white;font-weight:300;">Course List</h2></center>
                                        </div>
                                    <div class="panel-body table-responsive" style="padding-top:8px;">
                                        <table id="tbl_course" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Course Name</th>
                                                    <th>Description</th>
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        dt=$('#tbl_course').DataTable({
            "aLengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
            "ajax" : "RefCourse/transaction/list",
            "columns": [
                ...
                { targets:[1],data: "description" },
                {
                    ...
                    render: function (data, type, full, meta){
                        ...
                        return '<center>'+right_course_edit+right_course_delete+'</center>';
                    }
                }
    ...
    var bindEventHandlers=(function(){
        ...
        $('#tbl_course tbody').on( 'click', 'tr td.details-control', function () {
        ...
        $('#tbl_course tbody').on('click','button[name="edit_info"]',function(){
            _txnMode="edit";
            $('.transaction_type').text('Edit');
            $('#modal_create_course').modal('show');
            _selectRowObj=$(this).closest('tr');
            var data=dt.row(_selectRowObj).data();
            _selectedID=data.ref_course_degree_id;
        ...
        $('#tbl_course tbody').on('click','button[name="remove_info"]',function(){
            _selectRowObj=$(this).closest('tr');
            var data=dt.row(_selectRowObj).data();
            _selectedID=data.ref_course_degree_id;
        ...
        $('#btn_new').click(function(){
            ...
            $('#modal_create_course').modal('show');
            clearFields($('#frm_course'));
        });

        $('#btn_create').click(function(){
            if(validateRequiredFields($('#frm_course'))){
                if(_txnMode==="new"){
                    //alert("aw");
                    createCourse().done(function(response){
                        showNotification(response);
                ...
                if(_txnMode==="edit"){
                    //alert("update");
                    updateCourse().done(function(response){
                        showNotification(response);
                         if(response.stat=="error"){
                            $.unblockUI();
                             }
    ...
    var createCourse=function(){
        var _data=$('#frm_course').serializeArray();
    ...
    var updateCourse=function(){
        ...
        console.log(_data);
        _data.push({name : "ref_course_degree_id" ,value : _selectedID});
        ...
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"RefCourse/transaction/update",
            "data":_data,
            "beforeSend": showSpinningProgress($('#btn_save'))
        });
    };
    ...
    var removeCourse=function(){
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"RefCourse/transaction/delete",
            "data":{ref_course_degree_id : _selectedID},
            "beforeSend": showSpinningProgress($('#btn_save'))
        });
    };
