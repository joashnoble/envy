            ...
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="Record201">201 Record</a></li>
                    </ol>
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    ...
                                    <div style="font-size: 11pt;">
                                        <strong>NOTE: <span style="color: red;">201 Records are confidential Reports</span>. </strong><br>
...
$(document).ready(function(){
    ...
    $('#export_employee_201record').on('click', function() {
        filter_employee = $('#employee_filter_list').val();
        window.open("Hris_Reports/reports/export-record201/"+filter_employee+"","_self");
    });

    $('#email_employee_201record').on('click', function() {
        filter_employee = $('#employee_filter_list').val();
    ...
    $.ajax({
        "dataType":"json",
        "type":"POST",
        "url":"Hris_Reports/reports/email-record201/"+filter_employee+"",
