            ...
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="SchedDemography">Schedule Demography</a></li>
                    </ol>
                        ...
                        <div id="div_2316_list">
                            <div class="panel panel-default">
                                <div class="panel-heading" style="background-color:#2c3e50 !important;margin-top:2px;">
                                     <center><h2 style="color:white;font-weight:300;">Schedule Demography</h2></center>
                                </div>
                                <div class="panel-body table-responsive" style="padding-top:8px;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <label  style="float:left;margin-top:5px;margin-left: 20px;font-weight: bold;" for="inputEmail1">Pay Period :</label>
...
$(document).ready(function(){
    ...
    $.ajax({
        "dataType":"html",
        "type":"POST",
        "url":"SchedDemography/schedule/schedule-demography/"+filterdemog+"/"+filterdemogemp+"/fullview",
        beforeSend : function(){
